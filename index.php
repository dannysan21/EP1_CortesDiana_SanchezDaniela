  ...
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="./views/pedido.php">Agregar pedido</a></li>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="./views/verproductos.php">Visualizar productos (Modificar y eliminar)</a></li>
                  <li><a href="./views/productos.php">Agregar productos</a></li>
                </ul>
              </li>
            </ul>
          </div><!-- /.navbar-collapse -->
    ...
    <div class="front absolute card col-xs-12">
     <br>
      ...
      <big><center><h1 class="white-text" style="font-style: italic;">Upemor's pizzeria</h1></center></big>
    </div>
    </div>
  </body>
</html>
